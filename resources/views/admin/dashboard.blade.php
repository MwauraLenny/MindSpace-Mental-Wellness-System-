    ...
    <div class="py-10 bg-gradient-to-b from-amber-50 via-orange-50 to-rose-100/70">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                <div class="bg-white/95 overflow-hidden shadow-sm ring-1 ring-amber-100 sm:rounded-xl p-6">
            ...
            <div class="bg-white/95 overflow-hidden shadow-sm ring-1 ring-amber-100 sm:rounded-xl p-6">
                ...
                <div class="mt-4 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
                    @forelse($recentCommunityItems as $item)
                        <article class="rounded-lg border border-amber-200/70 bg-amber-50/40 p-4">
            ...
            <div class="bg-white/95 overflow-hidden shadow-sm ring-1 ring-amber-100 sm:rounded-xl p-6">
                ...
                <div class="mt-4 space-y-2">
                    @forelse($recentActivityPreview as $event)
                        <div class="rounded-lg border border-amber-200/70 bg-amber-50/40 px-4 py-3 text-sm flex items-center justify-between gap-3">
                            <div>
